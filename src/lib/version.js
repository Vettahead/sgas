...
export const RELEASES = [
  {
    ...
    notes: [
      ...
      'Every enquiry has a conversation under it. Type a message and post it; type @ and a name and a picker appears — pick Simon, say what you need, post. He sees an "@ you" count on the Enquiries menu item and the same badge on that enquiry in the list, opens it, answers on the same thread, and it comes back to you the same way. The notes that were already on your enquiries are the first message on each.',
