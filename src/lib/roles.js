...
export const ROLE_VIEWS = {
  ADMIN: ['dash', 'inquiries', 'book', 'setup', 'sched', 'calendar', 'assess', 'pay', 'delegates', 'companies', 'courses', 'admin', 'roadmap', 'changelog', 'help'],
  STANDARD: ['dash', 'inquiries', 'book', 'calendar', 'delegates', 'companies', 'help'],
  SCHEDULER: ['dash', 'inquiries', 'book', 'setup', 'sched', 'calendar', 'help'],
