...
export const ROLE_VIEWS = {
  ADMIN: ['dash', 'inquiries', 'book', 'sched', 'assess', 'pay', 'delegates', 'companies', 'staff', 'courses', 'admin'],
  STANDARD: ['dash', 'inquiries', 'book', 'delegates', 'companies'],
  SCHEDULER: ['dash', 'inquiries', 'book', 'sched'],
