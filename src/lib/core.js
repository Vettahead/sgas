...
export const store = {
  ...
  courses: [
    ...
    { course_id: 6, name: 'LPG Changeover', scheme: 'LPG', price: 620, teamup_designator: 'LPG', color: '#9a3fb5' },
    { course_id: 7, name: 'Catering Gas ACS', scheme: 'Catering', price: 1250, teamup_designator: 'CATER', color: '#c0392b' },
    { course_id: 8, name: 'Electrical (18th Edition)', scheme: 'Electrical', price: 680, teamup_designator: 'ELEC', color: '#2d3b8f' },
    { course_id: 9, name: 'Water & Plumbing', scheme: 'Water', price: null, teamup_designator: '', color: '#2f9bd6' },
    { course_id: 10, name: 'F-Gas / Air Conditioning', scheme: 'F-gas', price: null, teamup_designator: '', color: '#6d28d9' },
    { course_id: 11, name: 'Solid Fuel', scheme: 'Solid Fuel', price: null, teamup_designator: '', color: '#8a5a2b' },
    { course_id: 12, name: 'Gas Metering', scheme: 'Meters', price: null, teamup_designator: '', color: '#555e6e' },
    { course_id: 13, name: 'Commercial Laundry', scheme: 'Laundry', price: null, teamup_designator: '', color: '#d4669a' },
    { course_id: 14, name: 'Emergency Service & Metering', scheme: 'ESP', price: null, teamup_designator: '', color: '#c2410c' },
    { course_id: 15, name: 'I-GAS Industrial Gas Accreditation', scheme: 'IGAS', price: null, teamup_designator: '', color: '#15803d' },
    { course_id: 16, name: 'Industrial / Non-Domestic Gas', scheme: 'Industrial', price: null, teamup_designator: '', color: '#374151' },
    { course_id: 17, name: 'Limited Scope Commercial Gas', scheme: 'Limited Scope', price: null, teamup_designator: '', color: '#7c6f64' },
  ],
  categories: [
  ...
  sessionAssists: [
    { session_assist_id: 1, session_id: 4, staff_id: 2, from_date: '2026-07-08', to_date: '2026-07-09', note: null },
    { session_assist_id: 2, session_id: 2, staff_id: 1, from_date: '2026-06-25', to_date: '2026-06-26', note: null },
  ],
  bookings: [
  ...
  /* Two diary entries, and the second is the one worth having: office staff
     being trained by an outside company, with NOBODY on it yet. It belongs to
     no login and has no members, which is precisely the entry that used to be
     invisible on every calendar. */
  engagements: [
    { engagement_id: 1, owner_user_id: 1, title: 'LCL centre visit', start_date: '2026-06-18', end_date: '2026-06-18', half: null, kind: 'meeting', start_time: '10:00', end_time: '12:00', company_id: null },
    { engagement_id: 2, owner_user_id: null, title: 'Train the trainer', start_date: '2026-06-29', end_date: '2026-07-01', half: null, kind: 'training', start_time: null, end_time: null, company_id: 1 },
  ],
  engagementMembers: [
