...
export default function Staff() {
  ...
  const [ns, setNs] = useState({ name: '', room: '', email: '', teamup: '' })
  ...
  return (
    <div className="card">
      ...
      <div className="hint" style={{ margin: '14px 18px' }}>One shared list — anyone here can be assigned as <b>Trainer</b>, <b>Assessor</b> or <b>Verifier</b> on a course block. Each person's Teamup sub-calendar is where their assigned blocks get pushed.</div>
        ...
        <div className="body">
          <div className="subform">
            ...
            <div className="twocol">
              ...
              <Inp label="Teamup sub-calendar id" v={ns.teamup} on={(v) => setNs({ ...ns, teamup: v })} />
            </div>
            <div className="inrow">
      ...
      <table>
        <thead><tr><th>Name</th><th>Room</th><th>Email</th><th>Teamup sub-calendar</th></tr></thead>
        <tbody>
          {data.map((s) => (
            <tr key={s.staff_id}>
              ...
              <td className="muted small">{s.teamup || '—'}</td>
            </tr>
          ))}
        </tbody>
      </table>
