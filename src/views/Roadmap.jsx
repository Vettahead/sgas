...
const ITEMS = [
  ...
  { t: 'Access database import', s: 'progress', d: 'IN PROGRESS 29 Aug 2026. The old Access database is here and has been read: 20,980 assessment records, one flat table, about 8,300 people. The matching worklist is on the Data import tab above \u2014 122 qualification columns (59 match ours exactly, 25 are near-certain, the rest need a decision) and 40 different spellings of eleven staff names. Simon has said six years of history, which cuts it to about 4,500 records, 3,000 people and 96 employers. Still to settle: which of the three expiry columns counts, and that each row can hold two sittings rather than one.' },
