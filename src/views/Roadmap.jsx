...
const ITEMS = [
  ...
  { t: 'Access database import', s: 'progress', d: 'IN PROGRESS 29 Aug 2026. The old database is here and has been read \u2014 20,980 assessment records, one flat table, about 8,300 people. Scope agreed at seven years, which is 5,028 records, 3,266 people and 115 employers; without that cut there were 1,492 employers and nobody was ever going to match those by hand. The matching worklist is on the Data import tab: 122 qualification columns, 40 spellings of eleven staff names, and the employers. Where I have a match the dropdown is already set to it, so most rows are one click. Still to settle: which of the three expiry columns counts, and that each row can hold two sittings rather than one.' },
