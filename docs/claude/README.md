...
| `sgas-ui-conventions.md` | **UI/CSS house style — read before writing any screen** |
| `sgas-planner.md` | Planner (experimental calendar) — design rationale + 2026 library research |
